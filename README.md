...
![alt text](<Synchronous up counter image.png>)
...
![alt text](<Screenshot 2025-12-14 124753.png>)
...
![alt text](<Synchronous up counter RTL.png>)

**TIMING DIAGRAM FOR UP COUNTER**

![alt text](<Synchronous up counter wave.png>)
